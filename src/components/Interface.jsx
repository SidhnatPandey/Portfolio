  ...
  return (
    <Section>
      ...
      <div className="social-icons">
        <a href="https://www.linkedin.com/in/sidhant-pandey01/" target="_blank">
          <AnimatedIcon src={LinkedInIcon} alt="LinkedIn" />
        </a>
        <a href="https://github.com/SidhnatPandey" target="_blank">
          <AnimatedIcon src={githubIcon} alt="GitHub" />
        </a>
{/*         <a href="https://leetcode.com/" target="_blank">
          <AnimatedIcon src={LeetcodeIcon} alt="LeetCode" />
        </a> */}
        <a href="https://www.codechef.com/users/sidhant_01" target="_blank">
          <AnimatedIcon src={codechefIcon} alt="CodeChef" />
        </a>
        <a href="https://codeforces.com/profile/sidhantpandeynp6" target="_blank">
          <AnimatedIcon src={codeforcesIcon} alt="Codeforces" />
        </a>
        <a href="https://www.geeksforgeeks.org/user/sid01/" target="_blank">
      ...
      <h1> 
        ...
        <span className="px-1" style={{ fontFamily: 'Calligraphy', fontSize: '70px' }}>
          <span className="font-bold" style={{fontFamily: 'Calligraphy'}}>Sidhant Pandey</span>
        </span>
      </h1>
      <motion.p
      ...
      >
        <span className="font-custom" style={{ fontFamily: 'Roman', fontSize: '25px' }}>
          ...
          Software Developer
          <br />
          AWS Solution Architect Certified(SAA-C03)
          <br />
          SIH'22(Smart India Hackathon) Winner
          </span>
...
function ContactForm() {
  const [state, handleSubmit] = useForm("mqazkdke");
  if (state.succeeded) {
